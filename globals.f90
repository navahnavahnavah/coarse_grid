...
integer, parameter :: cellx = 10, celly = 2
integer, parameter ::  g_pri = 5, g_sec = 108, g_sol = 15, g_med = 7, g_iso = 2, cstep = 250, ar = 10 ! cstep = 1000
integer, parameter :: tn = 100000, mstep = 100, wscale = 1, ison = 10, inertn = 10! ison = 10000, inertn = 100000
...
integer :: jj_base, jj_top, len, i_count
