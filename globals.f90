...
integer, parameter ::  g_pri = 5, g_sec = 108, g_sol = 15, g_med = 7, g_iso = 2, cstep = 250, ar = 800 ! cstep = 1000
integer, parameter :: tn = 1000000, mstep = 25, wscale = 1, ison = 10, inertn = 10! ison = 10000, inertn = 100000
integer, parameter :: write_factor = 100, res_factor = 10 ! res factor is how many flushes happen within t_max
