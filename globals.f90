MODULE globals
  ...
  INTEGER, PARAMETER ::  g_pri = 5, g_sec = 80, g_sol = 15, g_med = 7, g_iso = 2, cstep = 250, ar = 400 ! cstep = 1000
  INTEGER, PARAMETER :: tn = 1000000, mstep = 50, wscale = 1, ison = 10, inertn = 10! ison = 10000, inertn = 100000
