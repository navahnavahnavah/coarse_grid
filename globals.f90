...
integer, parameter :: testInt = 31, xn =581, yn = 52, altnum = 134,  cell = 1 !50000
integer, parameter :: cellx = 10, celly = 1
integer, parameter ::  g_pri = 5, g_sec = 74, g_sol = 15, g_med = 7, g_iso = 2, cstep = 100, ar = 80 ! cstep = 1000
integer, parameter :: tn = 1000000, mstep = 500, wscale = 1, ison = 10, inertn = 10! ison = 10000, inertn = 100000
integer, parameter :: write_factor = 25, res_factor = 10 ! res factor is how many flushes happen within t_max
