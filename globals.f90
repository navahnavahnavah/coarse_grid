MODULE globals
  ...
  INTEGER, PARAMETER ::  g_pri = 5, g_sec = 74, g_sol = 15, g_med = 7, g_iso = 2, cstep = 1, ar = 100 ! cstep = 1000
  INTEGER, PARAMETER :: tn = 100000, mstep = 20, wscale = 1, ison = 10, inertn = 10! ison = 10000, inertn = 100000
